    ...
    return (
        <section className="flex flex-col items-center justify-center min-h-screen text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <div className="flex flex-col justify-content-center align-items-center gap-2"> {/* Stack items in mobile and row in larger screens */}
                    <Button asChild>
                        <Link href="/images/Ayari-Taha-CV-en.pdf">
                            Download CV
                        </Link>
                    </Button>
                    <a href="/images/TahaAyariCV.pdf" download className="btn btn-outline mt-2 sm:mt-0 sm:ml-4">
